  ...
  return (
    <div className="container mx-auto p-6">
      <div className="bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="mb-4">
          <label className="block text-gray-700 font-semibold">ProductId:</label>
          <p className="text-gray-900">{updatediscount.ProductId}</p>
        </div>
        <div className="mb-4">
          <label className="block text-gray-700 font-semibold">productName:</label>
          <p className="text-gray-900">{updatediscount.productName}</p>
        </div>
        <div className="mb-4">
          <label className="block text-gray-700 font-semibold">finalprice:</label>
          <p className="text-gray-900">{updatediscount.finalprice}</p>
        </div>
        ...
        <button href='/' className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-300">
            Back
          </button>
      </div>
    </div>
